# NOTE: THIS FILE IS CURRENTLY IN A SCRATCH STATE
...
# def calculate_layer_loss(predictions, teacher_labels, layer_loss_weights, balance_pos_neg = None, device = "cpu"):
#     """
...
# def calculate_lm_loss(outputs, targets, device = "cpu"):
#     assert outputs.shape == targets.shape, f"Shape mismatch between model outputs and target outputs {outputs.shape} vs {targets.shape}"
